...
frappe.PrintFormatBuilder = class PrintFormatBuilder {
    ...
    setup_sortable() {
        ...
        // section sorting
        Sortable.create(this.page.main.find(".print-format-builder-layout").get(0), { handle: ".print-format-builder-section-head" });
    }
        ...
        Sortable.create(col, {
            ...
            onAdd: function(evt) {
                ...
                if (!$item.hasClass("print-format-builder-field")) {
                    ...
                    var html = frappe.render_template("print_format_builder_field", { field: field, me: me });
    ...
    setup_add_section() {
        ...
        this.page.main.find(".print-format-builder-add-section").on("click", function() {
            ...
            var $section = $(frappe.render_template("print_format_builder_section", { section: section, me: me }))
